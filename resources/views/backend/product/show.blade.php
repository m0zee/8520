                    ...
                    <div class="item-preview">
                        <div class="item__preview-slider" style="width:99.9%">
                            ...
                            <div class="prev-slide">
                                <a href="{{ asset('storage/product/'.$product->img) }}" data-lightbox="gallery">
                                    <img id="img_01" src="{{ asset('storage/product/'.$product->img) }}"  data-zoom-image="{{ asset('storage/product/'.$product->img) }}" alt="1 Keep calm this isn't the end of the world, the preview is just missing.">
                                </a>
                            </div>
                                ...
                                @foreach ($product->gallery as $gallery)
                                    <div class="prev-slide">
                                        <a href="{{ asset('storage/product/gallery/'.$gallery->img) }}" data-lightbox="gallery">
                                            <img src="{{ asset('storage/product/gallery/'.$gallery->img) }}" alt="1 Keep calm this isn't the end of the world, the preview is just missing.">
                                        </a>
                                    </div>
                                @endforeach
                            @endif
