                                ...
                                <div class="col-md-4 col-sm-4">
                                    ...
                                    <div class="product product--card product--card-small">
                                        ...
                                        <div class="product-desc">
                                            <a href="{{ route('products.show', [$product->sub_category->category->slug, $product->sub_category->slug, $product->code, $product->slug ]) }}" class="product_title"><h4>{{ $product->name }}</h4></a>
                                            <ul class="titlebtm">
                                                <li>
