    ...
    <section class="dashboard-area">
        ...
        <div class="dashboard_contents">
            <div class="container">
                ...
                <form action="{{ route('buyer.requirements.store') }}" method="POST" class="setting_form">
                    {{ csrf_field() }}
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="name" id="name" class="text_field" placeholder="Requirement subject">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="quantity" id="quantity" class="text_field" placeholder="ex: 500">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="description" id="description" cols="30" rows="10" class="form-gorup text_field" placeholder="Type requirement description here..."></textarea>
                                                </div>
                                            </div>
