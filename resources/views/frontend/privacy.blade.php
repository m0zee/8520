...
{{-- <div id='ppHeader'>pakmaterial.com Privacy Policy</div> --}}
...
<div id='ppBody'>
    ...
    <div class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> To ask for ratings and reviews of services or products</div><span id='infoPro'></span>
    <br>
    ...
    <br>
    <div class='innerText'>If you turn cookies off it will turn off some of the features of the site.</div><span id='trDi'></span>
    <br>
    ...
    <div class='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Follow the instructions at the bottom of each email.</div> and we will promptly remove you from <strong>ALL</strong> correspondence.</div>
<br>
<br><strong><div class='blueText'>TRANSFERS OF INFORMATION</strong></div>
<br />
<div class='innerText'>Information about our customers, including Personal Information, may be disclosed as part of any merger, acquisition, debt financing, sale of company assets, as well as in the event of an insolvency, bankruptcy or receivership in which Personal Information could be transferred to third parties as one of our business assets. In such an event, we will attempt to notify you before your Personal Information is transferred, but you may not have the right to opt out of any such transfer.</div>
<br><strong><div class='blueText'>Lawful Use Only</strong></div>
<br />
<div class='innerText'>User will not publish, upload, submit or distribute any posted materials on PakMaterial.com which are unlawful, deceptive, misleading, or abusive in any way, including but not limited to posted materials that are defamatory, libelous, pornographic, obscene, threatening, indecent, invasive of privacy or publicity rights, hateful, or would constitute or encourage a criminal offense, violate the rights of any party, contain any corrupted data or malicious code that may impair or alter the appearance or functionality of PakMaterial.com, or give rise to liability or violate any local, state, federal or international law or regulation.On certain sections of PakMaterial.com, posted materials submitted for publication on will be accompanied by Users name and shall not be submitted anonymously. User warrants that such Posted Materials will not misrepresent or obscure his or her identity or affiliation with any person or entity. Furthermore, User warrants that it will not, by any method or action, directly or through a third party seek to artificially enhance, degrade, or otherwise manipulate the recommendations or endorsements of any User, individual, or group on PakMaterial.com including Users own.Certain sections of PakMaterial.com require registration to access and use information and services. If User elects to register, User agrees to provide accurate, complete registration information. User will inform PakMaterial.com of any changes to registration information. User warrants that registration is for a single person only, and that User will not permit anyone other than User to access and use sections of PakMaterial.com requiring registration using Users name and password. User will not access or use PakMaterial.com under the Username of another individual.</div><span id='ourCon'></span>
<br>
...
<div class='innerText'>PakMaterial.com</div>
<div class='innerText'>Lahore</div>Lahore, Punjab 54000
<div class='innerText'>Pakistan</div>
<div class='innerText'>support@pakmaterial.com</div>
<div class='innerText'>
    <br>Last Edited on 2018-05-14</div>
</div>
